  ...
  <div class="min-h-full">
    ...
    <header class="bg-white">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold tracking-tight text-defaultColor">Create New Article</h1>
      </div>
    </header>
    <main class="bg-white">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
        <form method="post" action="{{ url('/addArticle') }}" class="flex flex-col" enctype="multipart/form-data">
          @csrf
          <div class="flex">
            <div class="md:w-1/2">
              <div>
              ...
              <div class="py-5">
                <p class="text-md text-gray-800 pb-3">Body</p>
                <textarea class="w-3/4 h-screen px-2 py-2 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-backgroundColor focus:border-backgroundColor resize-none" name="body" placeholder="Body..."></textarea>
              </div>
            </div>
            <div class="w-1/4 mt-8 p-4 h-[200px] bg-blue-100 rounded-lg shadow-md">
