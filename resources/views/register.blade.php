...
<body>
    <div class="bg-gray-100 flex items-center justify-center p-4">
        ...
        <div class="w-full max-w-4xl bg-[#3DE5FF] rounded-[92px] shadow-lg overflow-hidden flex">
            ...
            <div class="w-1/2 bg-[#3DE5FF] p-12 flex flex-col justify-center">
                <h2 class="text-4xl font-bold text-white mb-12">Welcome to Our World!</h2>
                ...
                <form method="POST" action="{{ url('/signup') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="country_input" class="block text-black mb-2">Country</label>
                        <input
                            type="text"
                            name="country_input"
                            id="country_input"
                            class="w-full p-3 rounded-lg bg-white/90 border-0 focus:ring-2 focus:ring-white"
                            required
                            value="{{ old('country_input') }}"
                        >
                    </div>
                    <div>
                        <label for="gender_input" class="block text-black mb-2">Gender</label>
                        <input
                            type="gender"
                            name="gender_input"
                            id="gender_input"
    ...
    <div class="py-10 bottom-4 text-center text-gray-600 bg-gray-100">
