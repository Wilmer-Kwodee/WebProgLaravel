...
<body class="h-full">
  <div class="min-h-full">
    ...
    <main class="bg-white shadow">
      ...
      <div id="home-section-dailychallenge" class="relative mt-16 p-24 mx-auto max-w-7xl bg-blue-400 rounded-3xl">
        <h1 class="text-7xl font-bold text-white">Your daily Challenge!</h1>
        <div id="challenges">
          @foreach ($challenges as $challenge)
            <article class="py-3 my-6 max-w-screen-md bg-cyan-200 rounded-xl">
              <input type="checkbox" class="challenge-checkbox" id="challenge{{ $loop->index }}" name="challenge{{ $loop->index }}" value="{{ $challenge['challenge'] }}">
              <label class="text-2xl font-bold italic" for="challenge{{ $loop->index }}">{{ $challenge['challenge']}}</label>
            </article>
          @endforeach
        </div>
        {{-- @if()        
        ...
        <div class="decorations">
          <svg id="decoration-1" class="absolute top-0 left-0" height="100" width="100" xmlns="http://www.w3.org/2000/svg">
            <circle r="20" cx="50" cy="50" fill="lightgrey" />
          </svg>
...
<footer class=" bg-purple-950 p-16 mt-16 text-white">
  <div id="container" class="flex justify-between">
    <div id="left">
      <svg width="40" height="42" viewBox="0 0 60 62" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <h1>Drop by Drop</h1>
        <p>"Facilitate change through movement."</p>
        <div id="socials" class="flex mt-4">
    ...
    <div id="right" class="flex gap-10">
      <div id="menu-1">
        <h1>HOME</h1>
        <p>About</p>
        <p>Community</p>
  ...
  <hr class="my-10" />
  <div id="copyright" class="flex gap-5 justify-center">
    <p>Drop by Drop. @ Copyright. All Right Reserved. 2024</p>
